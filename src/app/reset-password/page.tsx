    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#0a0f1e] px-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white dark:bg-white/5 backdrop-blur-xl border border-gray-200 dark:border-white/10 rounded-2xl p-8 shadow-2xl">
          <h2 className="text-gray-900 dark:text-white text-xl font-semibold mb-2">Nouveau mot de passe</h2>
          ...
          <form onSubmit={handleReset} className="space-y-5">
            <div>
              ...
              <div className="relative">
                <input type={showPass ? 'text' : 'password'} required value={password}
                  ...
                  className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 pr-12 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-slate-600 text-sm focus:outline-none focus:border-[#1E5F7A] transition" />
            ...
            <div>
              ...
              <input type={showPass ? 'text' : 'password'} required value={confirm}
                ...
                className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-slate-600 text-sm focus:outline-none focus:border-[#1E5F7A] transition" />
            </div>
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-gray-400 dark:text-slate-500">
                {password.length === 0 ? '' :
                 ...
                 password.length < 12 ? 'Correct' : 'Fort'}
              </p>
            </div>
