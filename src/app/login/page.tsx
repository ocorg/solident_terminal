    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#0a0f1e] px-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-white border border-white/10 mb-4 shadow-lg shadow-[#1E5F7A]/20 overflow-hidden">
            <Image
